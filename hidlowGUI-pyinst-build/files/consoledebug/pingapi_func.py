...
def try_ping_ip():
    ...
    url = f"https://ipwhois.app/json/51.15.84.185"
...
def try_ping_ll():
    ...
    try:
        ...
        print(f"{Style.BRIGHT}Запрос: Geo API{Style.NORMAL}{Fore.RESET} |{Style.BRIGHT}{Fore.LIGHTGREEN_EX} API Доступно")
    except Exception as error_ll:
        print(f"{Fore.RED}Ошибка запроса Geo API |{Style.BRIGHT} API недоступно{Style.NORMAL}\n{error_ll}")
