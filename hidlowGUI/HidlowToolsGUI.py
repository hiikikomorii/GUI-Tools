...
def api_number():
    ...
    output_label.configure(text="wait..", text_color="white")
...
button4 = ctk.CTkButton(menu_frame, text="QRcode", width=50, corner_radius=10, command=select_qrcode).pack(side="left", padx=5)
button5 = ctk.CTkButton(menu_frame, text="Troll", width=50, corner_radius=10, command=trol).pack(side="left", padx=5)
button6 = ctk.CTkButton(menu_frame, text="Currency", width=50, corner_radius=10, command=select_currency).pack(side="left", padx=5)
...
button9 = ctk.CTkButton(menu_frame, text="API", width=50, corner_radius=10, command=hidlowapi_cmd).pack(side="left", padx=5)
...
entry.pack(pady=5)
confirm_button = ctk.CTkButton(entry_frame, text="OK", text_color="#00CF00", width=5)
confirm_button.pack(pady=5)
back_button = ctk.CTkButton(entry_frame, text="Back", text_color="red", width=5, command=go_back_from_entry)
...
aboutback_button = ctk.CTkButton(about_frame, text="Back", text_color="red", width=10, command=go_back)
aboutback_button.pack(pady=5)

#currency
btc_button = ctk.CTkButton(currency_frame, text="BTC", text_color="white", width=5, command=select_btc).pack(pady=3)
ton_button = ctk.CTkButton(currency_frame, text="TON", text_color="white", width=5, command=select_ton).pack(pady=3)
currencyback_button = ctk.CTkButton(currency_frame, text="Back", text_color="red", width=5, command=go_back)
currencyback_button.pack(pady=1)

#faker
rubtn = ctk.CTkButton(faker_frame, text="Russian", text_color="white", width=8, command=fakerru).pack(pady=3)
engbtn = ctk.CTkButton(faker_frame, text="English", text_color="white", width=8, command=fakereng).pack(pady=3)
kzbtn = ctk.CTkButton(faker_frame, text="Spanish", text_color="white", width=8, command=fakeres).pack(pady=3)
jpbtn = ctk.CTkButton(faker_frame, text="Japanese", text_color="white", width=8, command=fakerjp).pack(pady=3)
fakerback_button = ctk.CTkButton(faker_frame, text="Back", text_color="red", width=8, command=go_back)
fakerback_button.pack(pady=1)


#monitor
label_mon = ctk.CTkLabel(monitor_frame, text_color="white", font=("Arial", 30))
labelmem = ctk.CTkLabel(monitor_frame, text_color="white", font=("Arial", 30))
labelcpu = ctk.CTkLabel(monitor_frame, text_color="white", font=("Arial", 30))
label_info_monitor = ctk.CTkLabel(monitor_frame_stat, text_color="white", font=("Arial", 18))
monitorback_button = ctk.CTkButton(monitor_frame, text="Back", text_color="red", width=8, command=go_back)
